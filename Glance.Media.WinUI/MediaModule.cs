    ...
    IGlanceModule
{
    public void Register(IServiceCollection services)
    {
        ...
        services.AddSingleton<MediaComponent>();
        services.AddSingleton<IGlanceComponent>(provider => provider.GetRequiredService<MediaComponent>());
        services.AddSingleton<IGlanceActionProvider>(provider => provider.GetRequiredService<MediaComponent>());
