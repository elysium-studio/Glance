    ...
    IGlanceModule
{
    public void Register(IServiceCollection services)
    {
        ...
        services.AddSingleton<TimerComponent>();
        services.AddSingleton<IGlanceComponent>(provider => provider.GetRequiredService<TimerComponent>());
        services.AddSingleton<IGlanceActionProvider>(provider => provider.GetRequiredService<TimerComponent>());
        services.AddSingleton<IGlanceAssistantCommandHandler, TimerAssistantCommandHandler>();
        services
