    ...
    IGlanceModule
{
    public void Register(IServiceCollection services)
    {
        ...
        _ = services.AddViewFor<VoiceNotesRecentRecordingLimitSettingView, IGlanceModuleSettingViewModel, VoiceNotesRecentRecordingLimitSettingViewModel>(ServiceLifetime.Transient, provider => new VoiceNotesRecentRecordingLimitSettingView(), provider => new VoiceNotesRecentRecordingLimitSettingViewModel(provider, provider.GetRequiredService<IServiceFactory>(), provider.GetRequiredService<IMessenger>(), provider.GetRequiredService<IDisposer>(), provider.GetRequiredService<IDispatcher>(), provider.GetRequiredService<GlanceModuleOptions<VoiceNotesSettings>>().Current, provider.GetRequiredService<IWritableOptions<VoiceNotesSettings>>()));
    }
}
