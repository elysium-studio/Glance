...
#if DEBUG
        services.AddViewFor<WeatherTimePreviewSettingView, IGlanceModuleSettingViewModel, WeatherTimePreviewSettingViewModel>(ServiceLifetime.Transient, provider => new WeatherTimePreviewSettingView(), provider => new WeatherTimePreviewSettingViewModel(provider, provider.GetRequiredService<IServiceFactory>(), provider.GetRequiredService<IMessenger>(), provider.GetRequiredService<IDisposer>(), provider.GetRequiredService<IDispatcher>(), provider.GetRequiredService<GlanceModuleOptions<WeatherSettings>>().Current, provider.GetRequiredService<IWritableOptions<WeatherSettings>>()));
