    ...
    IGlanceModule
{
    public void Register(IServiceCollection services)
    {
        ...
        services.AddSingleton<PresenceComponent>();
        services.AddSingleton<IGlanceComponent>(provider => provider.GetRequiredService<PresenceComponent>());
        services.AddSingleton<IGlanceActionProvider>(provider => provider.GetRequiredService<PresenceComponent>());
