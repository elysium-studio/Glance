...
public sealed partial class SpotifyArtworkTransition :
    UserControl
{
    ...
    public static readonly DependencyProperty SourceProperty =
        DependencyProperty.Register(nameof(Source), typeof(ImageSource),
            typeof(SpotifyArtworkTransition), new PropertyMetadata(null, HandleSourceChanged));
    ...
    public SpotifyArtworkTransition()
    {
        InitializeComponent();
    ...
    private static void HandleSourceChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args) => ((SpotifyArtworkTransition)sender).UpdateSource((ImageSource?)args.NewValue);
