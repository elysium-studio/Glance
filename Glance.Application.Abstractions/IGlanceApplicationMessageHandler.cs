...
public interface IGlanceApplicationConnection
{
    ...
    ValueTask SendAsync(string capability, string topic, JsonElement payload, CancellationToken cancellationToken = default);
}

public sealed record GlanceApplicationMessage(string Capability, string Topic, JsonElement Payload);
