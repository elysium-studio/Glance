...
public partial class PowerViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string statusText = "Desktop power";

    [ObservableProperty]
    private string powerSourceText = "AC power";

    [ObservableProperty]
    private string detailText = "No battery detected";
    ...
    public void Update(PowerSnapshot snapshot)
    {
        ...
        PowerSourceText = snapshot.IsOnBattery ? "Battery power" : "AC power";
        ...
        (CompactStatusText, StatusText) = snapshot.BatteryState switch
        {
            ...
            _ => ("Connected", "Desktop power")
        };

        DetailText = snapshot.BatteryState switch
        {
            BatteryState.NotPresent => "No battery detected",
