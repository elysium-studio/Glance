    ...
    IGlanceModule
{
    public void Register(IServiceCollection services)
    {
        ...
        services.AddSingleton<ScreenCaptureComponent>();
        services.AddSingleton<IGlanceComponent>(provider => provider.GetRequiredService<ScreenCaptureComponent>());
        services.AddSingleton<IGlanceActionProvider>(provider => provider.GetRequiredService<ScreenCaptureComponent>());
        services.AddSingleton<IGlanceAssistantCommandHandler, ScreenCaptureAssistantCommandHandler>();
